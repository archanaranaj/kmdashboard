...
//       if (result.status && result.data) {
//         // FIX: Extract the petty_cash array from the response
//         setPettyCashEntries(result.data.petty_cash || []);
//       } else {
//         setPettyCashEntries([]);
//       }
//     } else {
...
//       if (result.status && result.data) {
//         // FIX: Extract the sales_cash array from the response
//         setPettySalesEntries(result.data.sales_cash || []);
//       } else {
//         setPettySalesEntries([]);
//       }
//     } else {
